...
function mainFunction() {
    ...
    function closeNav() {
        ...
        mobileNavToggler.children[0].classList.replace("fa-arrow-alt-circle-left", "fa-arrow-alt-circle-right");
    ...
    function openNav() {
        ...
        mobileNavToggler.children[0].classList.replace("fa-arrow-alt-circle-right", "fa-arrow-alt-circle-left")
